    ...
    <section id="step-guide" className="py-12 sm:py-16 lg:py-24 bg-background overflow-hidden relative">
      <div className="max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-10 sm:mb-14 lg:mb-20">
          ...
          <p className="text-sm sm:text-base md:text-lg text-muted font-medium max-w-2xl mx-auto px-2">
        ...
        <div className="max-w-7xl mx-auto flex flex-col gap-14 sm:gap-20 lg:gap-28">
          {steps.map((step, index) => (
            ...
            >
              <div className="w-full lg:w-[40%] flex flex-col justify-center text-center lg:text-left px-2 sm:px-0">
                ...
                <p className="text-[15px] sm:text-base lg:text-lg text-muted font-medium leading-relaxed">{step.desc}</p>
              </div>
              ...
              >
                ...
                <div className="relative p-1.5 sm:p-2 bg-card border border-border rounded-[1.5rem] sm:rounded-[2rem] shadow-xl overflow-hidden transform-gpu">
                  ...
                  <div className="absolute inset-0 bg-black/0 group-hover:bg-black/30 transition-colors duration-300 rounded-[1.5rem] sm:rounded-[2rem] flex items-center justify-center m-1.5 sm:m-2">
                    <div className="w-12 h-12 sm:w-16 sm:h-16 bg-black/70 rounded-full flex items-center justify-center text-white opacity-0 group-hover:opacity-100 transform-gpu scale-75 group-hover:scale-100 transition-all duration-300 backdrop-blur-sm shadow-2xl">
          ...
          >
            ...
            <FaGift className="text-4xl sm:text-5xl lg:text-6xl mx-auto mb-3 sm:mb-4 lg:mb-6 text-white/95 relative z-10 animate-bounce" />
            <h3 className="text-xl sm:text-2xl lg:text-4xl font-black mb-2 sm:mb-3 lg:mb-4 relative z-10">Final Step: Claim Extra $5 USDT</h3>
            <p className="text-[13px] sm:text-base lg:text-lg font-medium max-w-2xl mx-auto relative z-10 text-white/90 leading-relaxed px-2">

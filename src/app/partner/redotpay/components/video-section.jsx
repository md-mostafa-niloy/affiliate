  ...
  return (
    <section className="py-10 sm:py-16 lg:py-20 bg-background relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          <div className="relative aspect-video bg-card rounded-2xl sm:rounded-[2rem] border border-border group-hover:border-primary/40 overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 transform-gpu group-hover:-translate-y-1">
            <img 
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div 
            ...
            className="fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-6 bg-black/95 cursor-pointer"
          ...
          >
            <motion.div 
              ...
              transition={{ duration: 0.2 }}
              className="relative w-full max-w-5xl aspect-video bg-black rounded-xl sm:rounded-[2rem] overflow-hidden border border-white/10 shadow-2xl cursor-default transform-gpu"

...
export function RizonVideo() {
  ...
  return (
    <section className="py-10 sm:py-16 lg:py-20 bg-background relative overflow-hidden border-t border-border/50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-12">
          ...
          >
            How to Setup <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent">Rizon</span>
          </motion.h2>
          <motion.p 
            initial={{ opacity: 0, y: 10 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            className="text-sm sm:text-base md:text-lg text-foreground/80 font-medium px-2"
          >
            Watch our complete guide on how to register, apply your <span className="font-bold text-primary">TWKFW</span> invite code, and use the <span className="font-bold text-primary">NR</span> coupon for a 90% discount.
          </motion.p>
        </div>
        ...
        >
          <div className="relative aspect-video bg-card rounded-2xl sm:rounded-[2rem] border border-border group-hover:border-primary/50 overflow-hidden shadow-lg transition-colors duration-300 isolate">
            <img 
              src="/partner/assets/rizon-og.png" 
              alt="Rizon App Tutorial"
              loading="lazy"
          ...
          >
            ...
            >
              ...
              <div className="relative w-full aspect-video bg-black overflow-hidden rounded-xl sm:rounded-2xl">
                <iframe 
                  src="https://www.youtube.com/embed/Tt-UMAr_JTM?autoplay=1&rel=0&modestbranding=1" 
                  title="Rizon Tutorial"

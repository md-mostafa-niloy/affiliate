...
export function TevauVideo() {
  ...
  return (
    <section id="tutorial-section" className="py-10 sm:py-16 lg:py-20 bg-background relative overflow-hidden border-t border-border/50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-12">
          ...
          >
            How to Setup <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent">Tevau</span>
          </motion.h2>
          <motion.p 
            initial={{ opacity: 0, y: 10 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Watch our complete guide on how to register, apply your <span className="font-bold text-primary">VISERNIC - VISERNIC8</span> code, and order your discounted card.
          </motion.p>
        </div>
        ...
        >
          <div className="relative aspect-video bg-card rounded-2xl sm:rounded-[2rem] border border-border group-hover:border-primary/50 overflow-hidden shadow-lg transition-colors duration-300 isolate">
            <img 
              src="/partner/assets/tevau-og.png" 
              alt="Tevau App Tutorial"
              loading="lazy"

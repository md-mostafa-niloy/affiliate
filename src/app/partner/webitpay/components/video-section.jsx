    ...
    <section className="py-10 sm:py-16 lg:py-20 bg-background relative overflow-hidden border-t border-border/50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-12">
          ...
          >
            How to Setup <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent">Webitpay</span>
          </motion.h2>
          <motion.p 
            initial={{ opacity: 0, y: 10 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Watch our complete guide on how to register, apply your <span className="font-bold text-primary">vsnbd</span> code, and claim your FREE Virtual Card.
          </motion.p>
        </div>
        ...
        >
          <div className="relative aspect-video bg-card rounded-2xl sm:rounded-[2rem] border border-border group-hover:border-primary/50 overflow-hidden shadow-lg transition-colors duration-300 isolate">
            <img 
              src="/partner/assets/webitpay-og.png" 
              alt="Webitpay App Tutorial"
              loading="lazy"
          ...
          >
            ...
            >
              ...
              <div className="relative w-full aspect-video bg-black overflow-hidden rounded-xl sm:rounded-2xl">
                <iframe 
                  src="https://www.youtube.com/embed/kl19ctgBJc8?autoplay=1&rel=0&modestbranding=1" 
                  title="Webitpay Tutorial"
